...
root_init_real := $(TARGET_ROOT_OUT)/init.real
	...
	# and make /init be a symlink to /sbin/preboot (which will execute
	# /init.real, if appropriate.
$(root_init_real): $(root_init) $(TARGET_ROOT_OUT)/sbin/preboot $(PRODUCT_OUT)/utilities/toybox
